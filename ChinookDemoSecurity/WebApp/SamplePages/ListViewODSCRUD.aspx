<%@ Page Title="ODS CRUD" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListViewODSCRUD.aspx.cs" Inherits="WebApp.SamplePages.ListViewODSCRUD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote>
        ...
        this sample will use miminal code behind<br />
        this sample will demonstrate the user of the course supplied error handling control<br />
        this sample will demonstrate validation on a ListView CRUD
    </blockquote>
    <div class="row">
        <uc1:MessageUserControl runat="server" ID="MessageUserControl" />
        <%-- we need two Validation Summary controls, one for Edit and one for Insert --%>
    ...
    <div class="row">
       <%-- <div class="offset-1">--%>
            ...
            <asp:ListView ID="AlbumList" runat="server" 
                    ...
                    <tr style="background-color: #FFFFFF; color: #284775;">
                        ...
                        <td>
                            <asp:Label Text='<%# Eval("ReleaseYear") %>' runat="server" 
                                ID="ReleaseYearLabel" Width="90px"/></td>
                        <td>
                            <asp:Label Text='<%# Eval("ReleaseLabel") %>' runat="server" ID="ReleaseLabelLabel" /></td>
                    </tr>
                </AlternatingItemTemplate>
                <EditItemTemplate>
                    <asp:RequiredFieldValidator ID="RequiredFieldTitleTextBoxE" runat="server" 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldReleaseYearTextBoxE" runat="server" 
                    ...
                    <tr style="background-color: #999999;">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" 
                                ID="ReleaseYearTextBoxE" Width="90px" TextMode="Number"/></td>
                        <td>
                ...
                <InsertItemTemplate>
                    <asp:RequiredFieldValidator ID="RequiredFieldTitleTextBoxI" runat="server" 
                        ErrorMessage="Title is required" Display="None"
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldReleaseYearTextBoxI" runat="server" 
                        ErrorMessage="Year is required" Display="None"
                    ...
                    <tr style="">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseYear") %>' runat="server" 
                                ID="ReleaseYearTextBoxI" Width="90px" TextMode="Number"/></td>
                        <td>
                            <asp:TextBox Text='<%# Bind("ReleaseLabel") %>' runat="server" 
