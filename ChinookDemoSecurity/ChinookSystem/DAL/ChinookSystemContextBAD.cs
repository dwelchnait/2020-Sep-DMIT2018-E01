namespace ChinookSystem.DAL
{
    ...
    internal partial class ChinookSystemContextBAD : DbContext
    {
        //changed the connection string name so it will NOT be found
        public ChinookSystemContextBAD()
            : base("name=ChinookBAD")
        {
        }
